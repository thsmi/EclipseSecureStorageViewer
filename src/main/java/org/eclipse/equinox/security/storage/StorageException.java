...
final public class StorageException extends Exception {
	...
	public static final int BAD_STORAGE_FILE = 5;
	public static String badStorageFile = "Bad Storage File";

	public static final int BAD_STORAGE_VERSION = 6;
	public static String badStorageVersion = "Bad Storage Version";
